...
def get_renewable_snapshots(config, year):
    ...
    if "start_month" in ren_sns_config:
        ...
        # If end_inclusive is true, include the full final day.
        # Example: 2019-12-31 becomes 2020-01-01 with inclusive="left",
        # so the selected hours include 2019-12-31 23:00.
        if end_inclusive:
        ...
        logger.info(
            ...
            f"({'inclusive full end day' if end_inclusive else 'exclusive end day'})",
        )
